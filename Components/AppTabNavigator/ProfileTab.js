...
import { Icon, Container, Content, Right, Left, Card, CardItem, Body, Header,Button } from 'native-base';
...
export default class ProfileTab extends React.Component {
    ...
    render() {
        ...
        return (
            <Container style={{ backgroundColor: 'white', marginLeft: 0 }}>
                <Header>
                    <Left>
                        <Icon name="md-person-add" style={{ paddingLeft: 10 }} />
                    </Left>
                    <Body>
                        <Text style={{}}>Alex Yungan</Text>
                    </Body>
                    <Right>
